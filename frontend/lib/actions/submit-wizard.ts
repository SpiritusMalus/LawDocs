...
const FIELD_LABELS: Record<string, string> = {
  ...
  store_name: "Магазин",
  store_address_city: "Город магазина",
  store_address_street: "Улица магазина",
  store_address_house: "Дом магазина",
  store_address_building: "Корпус магазина",
  store_address_structure: "Строение магазина",
  store_site: "Сайт магазина",
  product_name: "Товар",
  product_price: "Цена, ₽",
