...
export const metadata: Metadata = {
  ...
  description:
    "LawDocs — онлайн-сервис подготовки юридических документов: претензии, жалобы и заявления со ссылками на закон за 5 минут.",
};
...
export default function AboutPage() {
  return (
    <article className="max-w-3xl mx-auto px-4 py-16 prose prose-gray">
      ...
      <p className="text-gray-700 leading-relaxed">
        LawDocs мы запустили в 2026 году именно поэтому. Мы автоматизировали то, что юристы
