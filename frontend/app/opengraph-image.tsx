...
export const alt = "LawDocs — готовый юридический документ за 5 минут, 500 ₽";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          >
            Готовый юридический документ за 5 минут — 500 ₽
          </div>
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            оформленная по всем правилам. Шаблоны проверены практикующим юристом.
          </div>
        </div>
