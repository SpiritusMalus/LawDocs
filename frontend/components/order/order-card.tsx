...
const SITUATION_TITLES: Record<string, string> = {
  ...
  bank_block: "Банк заблокировал счёт по 115-ФЗ",
  court_order: "Отменить судебный приказ",
  gibdd: "Оспорить штраф ГИБДД",
  rental_deposit: "Арендодатель не возвращает залог",
  tour_operator: "Туроператор не вернул деньги за тур",
  online_course: "Онлайн-школа не возвращает деньги",
  neighbor_flood: "Сосед затопил квартиру",
  repair: "Подрядчик плохо сделал ремонт",
  telecom: "Интернет или телефон не работает",
  medical: "Медицинская организация нарушила права",
  ddu_delay: "Застройщик задержал передачу квартиры",
  ddu_defects: "Застройщик сдал квартиру с недостатками",
  ddu_termination: "Расторгнуть ДДУ и вернуть деньги",
  dtp_osago: "Страховая не платит по ОСАГО",
  auto_repair: "Автосервис плохо отремонтировал",
  debt_collector: "Коллекторы нарушают закон",
  carsharing: "Каршеринг предъявил необоснованный ущерб",
  gym_refund: "Фитнес-клуб не возвращает деньги",
