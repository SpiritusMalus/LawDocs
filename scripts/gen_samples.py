...
2. ПОРЯДОК: сначала шапка (кому / от кого), затем заголовок документа одним словом (ПРЕТЕНЗИЯ / ЖАЛОБА / ЗАЯВЛЕНИЕ / ВОЗРАЖЕНИЕ / УВЕДОМЛЕНИЕ), затем основной текст. Не меняй порядок.
...
4. Заголовок — одно слово заглавными, без пояснений и подзаголовков. Не пиши после заголовка город или дату.
