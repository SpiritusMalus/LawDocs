...
| LLM (fallback) | YandexGPT (Яндекс API) | API |
...
### GigaChat как основной LLM, YandexGPT как fallback
**Решение**: GigaChat (Сбер) — основной, YandexGPT — fallback при ошибке.  
**Почему**: оба провайдера работают в российской юрисдикции (обе Яндекс/Сбер, отсутствие рисков блокировки по 152-ФЗ и иностранным санкциям). Единый РФ-стек гарантирует хранение ПДн в РФ, лучший контекст русского правовой среды, отсутствие рисков перебоев по политическим причинам.
