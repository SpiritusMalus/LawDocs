...
class Document(Base):
    ...
    # Ключи watermarked-превью (по странице), показываются ДО оплаты. Не E2EE —
    # их рендерит сервер; чистый docx/pdf под gate'ом DONE и шифрованием юзера.
    preview_keys: Mapped[list] = mapped_column(JSON, nullable=False, default=list)
