...
const INCLUDED = [
  "Документ в форматах .docx и .pdf",
  "Расчёт неустойки или процентов, если применимо",
  "Ссылки на актуальные статьи закона",
  "Инструкция: куда отправить и в какой срок",
  "Шаблон ответа, если вторая сторона напишет возражение",
